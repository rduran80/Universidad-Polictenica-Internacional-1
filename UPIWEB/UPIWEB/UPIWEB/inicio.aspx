        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3" colspan="2">
                    <asp:Image ID="Image1" runat="server" Height="152px" ImageUrl="~/Imagenes/CALC.png" Width="165px" />
                    <br />
                    <br />
                    <br />
...
&nbsp;&nbsp;
                    <asp:RadioButton ID="RadioDiv" runat="server" Font-Size="X-Large" GroupName="b1" Text="División" />
                    <br />
                    <br />
                    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckMulti" runat="server" Font-Size="X-Large" Text="Multiplicación" />
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckDiv" runat="server" Font-Size="X-Large" Text="División" />
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <asp:Button runat="server" BackColor="Red" Height="77px" OnClick="Button1_Click" Text="CALCULAR 1" Width="200px" />
                    <asp:Button ID="Button2" runat="server" BackColor="#FF9933" Height="77px" OnClick="Button2_Click" Text="CALCULAR 2" Width="200px" />
                    <asp:Button ID="Button3" runat="server" BackColor="#CCFF99" Height="77px" OnClick="Button3_Click" Text="CALCULAR 3" Width="200px" />
                    <asp:Button ID="Button4" runat="server" BackColor="#6666FF" Height="66px" OnClick="Button4_Click" Text="CALCULAR 4" Width="200px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                </td>
                <td>&nbsp;</td>
